...
import { SiDjango, SiMongodb, SiMysql, SiCplusplus, SiPowerbi, SiTableau, SiSnowflake, SiOracle, SiAmazonaws } from "react-icons/si";
    ...
    <div className="border-b border-neutral-800 pb-24">
      ...
      >
        ...
        <motion.div 
          ...
          animate="animate"
          className="rounded-2xl border-4 border-neutral-800 p-4">
          <SiPowerbi className="text-7xl text-blue-700" />
        </motion.div>
        <motion.div 
          variants={iconVariants(5.5)}
          initial="initial"
        ...
        <motion.div 
          ...
          animate="animate"
          className="rounded-2xl border-4 border-neutral-800 p-4">
          <SiSnowflake className="text-7xl text-blue-700" />
        </motion.div>
        <motion.div 
          variants={iconVariants(5.5)}
          initial="initial"
          animate="animate"
          className="rounded-2xl border-4 border-neutral-800 p-4">
          <SiOracle className="text-7xl text-blue-700" />
        </motion.div>
        <motion.div 
          variants={iconVariants(5.5)}
          initial="initial"
          animate="animate"
          className="rounded-2xl border-4 border-neutral-800 p-4">
          <SiAmazonaws className="text-7xl text-blue-700" />
        </motion.div>
      </motion.div>
    </div>
  );
