  ...
  return (
    <div ref={ref} className="border-b border-neutral-900 pb-4 lg:mb-35">
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            <motion.h1
              ...
              className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-7xl text-black"
            >
              Lakshmi Vijaya Aashritha Nelavelli
            </motion.h1>
            <motion.span
        ...
        <div className="w-full lg:w-1/2 lg:relative lg:top-[-50px] lg:left-[20px]">
          <div className="flex justify-center">
            <motion.img
              ...
              src={profilePic}
              alt="Lakshmi Vijaya Aashritha Nelavelli"
            />
          </div>
        </div>
      </div>
